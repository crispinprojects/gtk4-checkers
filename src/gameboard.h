...
GDK_AVAILABLE_IN_ALL void game_board_update (GameBoard *board);
...
GDK_AVAILABLE_IN_ALL int game_board_number_white_pieces();
GDK_AVAILABLE_IN_ALL int game_board_number_black_pieces();
GDK_AVAILABLE_IN_ALL void game_board_remove_player(int x, int y);
...
GDK_AVAILABLE_IN_ALL  void game_board_get_possible_white_moves(GArray *possible_moves);
GDK_AVAILABLE_IN_ALL  void game_board_get_possible_black_moves(GArray *possible_moves);
...
GDK_AVAILABLE_IN_ALL gboolean game_board_can_capture(int x, int y);

GDK_AVAILABLE_IN_ALL Move game_board_get_AI_move();
GDK_AVAILABLE_IN_ALL Move game_board_make_AI_move();
GDK_AVAILABLE_IN_ALL  void game_board_show_console_board();

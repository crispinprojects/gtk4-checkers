...
static void activate(GtkApplication *app, gpointer user_data) {
    ...
    load_css(
        ...
        "}"
        // CSS for piece images using SVG data URLs
        // Note: SVG colors are URL-encoded. %23 is #
        ".wman {"
        "  background-image: url('data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 100 100\"><circle cx=\"50\" cy=\"50\" r=\"45\" fill=\"%23F0F0F0\" stroke=\"%23A0A0A0\" stroke-width=\"4\"/></svg>');"
        "  background-size: contain;"
        "  background-repeat: no-repeat;"
        "  background-position: center;"
        "}"
        ".bman {"
        "  background-image: url('data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 100 100\"><circle cx=\"50\" cy=\"50\" r=\"45\" fill=\"%23303030\" stroke=\"%23101010\" stroke-width=\"4\"/></svg>');"
        "  background-size: contain;"
        "  background-repeat: no-repeat;"
        "  background-position: center;"
        "}"
        ".wking {"
        "  background-image: url('data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 100 100\"><circle cx=\"50\" cy=\"50\" r=\"45\" fill=\"%23F0F0F0\" stroke=\"%23FFD700\" stroke-width=\"6\"/><circle cx=\"50\" cy=\"50\" r=\"20\" fill=\"%23000000\"/></svg>');"
        "  background-size: contain;"
        "  background-repeat: no-repeat;"
        "  background-position: center;"
        "}"
        ".bking {"
        "  background-image: url('data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 100 100\"><circle cx=\"50\" cy=\"50\" r=\"45\" fill=\"%23303030\" stroke=\"%23C0C0C0\" stroke-width=\"6\"/><circle cx=\"50\" cy=\"50\" r=\"20\" fill=\"%23FFFFFF\"/></svg>');"
        "  background-size: contain;"
        "  background-repeat: no-repeat;"
        "  background-position: center;"
        "}"
